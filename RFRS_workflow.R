...
datafile="~/Data/processed_final2_train_survival_combined_gcrma.txt" #combined (standardCDF + customCDF)
clindatafile="~/Data/filtered_combined_data_anno.final.train.2.txt"
